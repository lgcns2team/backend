...
-- 16 쓰시마 상륙전
('쓰시마 상륙전',
 '이종무가 대마도에 상륙하여 왜구 촌락을 소각하고 항복을 받아냄.',
 34.41, 129.32,
 '이종무', '소 사다모리',
 DATE '1419-06-20',
 (SELECT war_id FROM war WHERE name = '쓰시마 정벌'),
 NULL,
 NULL
),
...
-- 17 북청 전투
('북청 전투',
 '이시애의 본거지인 북청에서 관군이 반란군을 격파함.',
 40.2486, 128.3342,
 '허종', '이시애',
 DATE '1467-07-15',
 (SELECT war_id FROM war WHERE name = '이시애의 난'),
 NULL,
 NULL
),
...
-- 18 달량진 전투
('달량진 전투',
 '을묘왜변 당시 왜구가 전남 해남 달량진성을 포위 공격함.',
 34.3964, 126.6142,
 '왜구', '조안국',
 DATE '1555-05-11',
...
-- 19 충주 탄금대 전투
('충주 탄금대 전투',
 '신립이 배수진을 치고 일본군과 맞섰으나 조총 공격에 전멸함.',
 36.98, 127.91,
 '고니시', '신립',
 DATE '1592-04-28',
...
-- 21 한산도 대첩
('한산도 대첩',
 '학익진 전술로 일본 수군 주력을 괴멸시킨 임진왜란 3대 대첩.',
 34.795, 128.505,
 '이순신', '와키자카',
 DATE '1592-07-08',
 (SELECT war_id FROM war WHERE name = '임진왜란'),
...
-- 22 웅치 전투
('웅치 전투',
 '전라도로 진입하려는 왜군을 의병과 관군이 육탄으로 막아낸 전투.',
 35.8361, 127.2236,
 '정담', '안코쿠지',
 DATE '1592-08-13',
 (SELECT war_id FROM war WHERE name = '임진왜란'),
...
-- 23 이치 전투
('이치 전투',
 '권율이 금산과 완주 경계인 이치에서 왜군을 격퇴하여 호남을 방어함.',
 36.1244, 127.3825,
 '권율', '고바야카와',
 DATE '1592-08-14',
 (SELECT war_id FROM war WHERE name = '임진왜란'),
...
-- 24 진주 대첩
('진주 대첩',
 '김시민이 3,800명으로 2만 대군을 막아낸 성곽 방어전.',
 35.19, 128.08,
 '김시민', '호소카와',
 DATE '1592-10-05',
 (SELECT war_id FROM war WHERE name = '임진왜란'),
...
-- 26 행주 대첩
('행주 대첩',
 '권율이 행주산성에서 관군, 승병, 부녀자들과 함께 대승을 거둠.',
 37.6, 126.81,
 '권율', '우키타',
 DATE '1593-02-12',
 (SELECT war_id FROM war WHERE name = '임진왜란'),
...
-- 28 명량 해전
('명량 해전',
 '이순신이 13척의 배로 133척의 일본 수군을 울돌목에서 격파함.',
 34.56, 126.3,
 '이순신', '도도',
 DATE '1597-09-16',
 (SELECT war_id FROM war WHERE name = '임진왜란'),
...
-- 30 사르후 전투
('사르후 전투',
 '조·명 연합군이 후금군에게 각개격파 당하고 강홍립이 투항함.',
 41.83, 124,
 '누르하치', '강홍립',
 DATE '1619-03-04',
 (SELECT war_id FROM war WHERE name = '사르후 전투'),
 NULL,
 NULL
),
...
-- 31 안현 전투
('안현 전투',
 '이괄의 반란군을 정충신이 서대문 밖 안현에서 격파하여 난을 진압함.',
 37.5736, 126.9608,
 '정충신', '이괄',
 DATE '1624-02-11',
 (SELECT war_id FROM war WHERE name = '이괄의 난'),
 NULL,
 NULL
),
...
-- 32 용골산성 전투
('용골산성 전투',
 '정봉수가 의병을 이끌고 험준한 지형을 이용해 후금군을 막아냄.',
 39.95, 124.7,
 '정봉수', '아민',
 DATE '1627-02-01',
...
-- 34 쌍령 전투
('쌍령 전투',
 '경상도 근왕군 4만이 청나라 기병 300명에게 기습당해 궤멸된 패전.',
 37.4042, 127.2831,
 '청군', '허완',
 DATE '1637-01-26',
 (SELECT war_id FROM war WHERE name = '병자호란'),
...
-- 35 광교산 전투
('광교산 전투',
 '김준용이 이끄는 전라 병영군이 수원 광교산에서 청군에게 승리함.',
 37.33, 127.03,
 '김준용', '양굴리',
 DATE '1637-01-05',
 (SELECT war_id FROM war WHERE name = '병자호란'),
...
-- 36 정주성 전투
('정주성 전투',
 '관군이 홍경래군이 점거한 정주성을 폭파하여 함락시킨.',
 39.68, 125.22,
 '관군', '홍경래',
 DATE '1812-04-19',
 (SELECT war_id FROM war WHERE name = '홍경래의 난'),
 NULL,
 NULL
),
...
-- 37 정족산성 전투
('정족산성 전투',
 '양헌수 부대가 강화도 정족산성에서 프랑스군을 매복 공격으로 격퇴함.',
 37.66, 126.49,
 '양헌수', '올리비에',
 DATE '1866-11-09',
 (SELECT war_id FROM war WHERE name = '병인양요'),
 NULL,
 NULL
),
...
-- 38 광성보 전투
('광성보 전투',
 '어재연 장군과 조선군이 미군의 총공세에 맞서 전멸할 때까지 싸움.',
 37.73, 126.53,
 '로저스', '어재연',
 DATE '1871-06-11',
 (SELECT war_id FROM war WHERE name = '신미양요'),
 NULL,
 NULL
),
...
-- 39 황토현 전투
('황토현 전투',
 '동학농민군이 관군을 상대로 거둔 최초의 대규모 승리.',
 35.6311, 126.8839,
 '전봉준', '이광양',
 DATE '1894-05-11',
 (SELECT war_id FROM war WHERE name = '동학농민혁명'),
 NULL,
 NULL
),
...
-- 40 우금치 전투
('우금치 전투',
 '서울로 북상하던 농민군이 일본군과 관군의 화력에 밀려 패배한 결정적 전투.',
 36.4361, 127.1336,
 '일본군', '전봉준',
 DATE '1894-12-05',
 (SELECT war_id FROM war WHERE name = '동학농민혁명'),
